...
class DatabaseHelper {
  ...
  static const recipeTable = 'recipeTable';
  static const ingredientTable = 'ingredientTable';
  ...
  // SQL code to create database table
  // this open the database (and creates it if it doesn't exist)
  ...
  Future<BriteDatabase> get steamDatabase async {
    await database;
    return _streamDatabase;
  }

  // PARSE RECIPE AND INGREDIENT DATA
  ...
  Future<List<Recipe>> findAllRecipes() async {
    final db = await instance.steamDatabase;
